 ...
 *
 */
#ifndef FIRMWARE_SETUP_H
#define FIRMWARE_SETUP_H
...
//pay attention to the following data type and endianness directions:
...
#define DOORID_BYTE1 0x32   //unsigned char in hex
#define DOORID_BYTE2 0xE8   //unsigned char in hex
#define DOORID_BYTE3 0x51   //unsigned char in hex
