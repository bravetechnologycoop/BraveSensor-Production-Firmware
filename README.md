...
3. [Repo Branches Outline](#repo-branches-outline)
4. [Two Argon and XeThru Firmware](#two-argon-and-xethru-firmware)
...
5. [Two Argons and INS Firmware](#two-argons-and-ins-firmware)
      - [Firmware Settings](#firmware-settings)
        - [INS3331_PARTICLE](#ins3331_particle)
      - [Console Function Instructions](#console-function-instructions)
      - [Published Events](#published-events)
          - [INS3331 Data](#ins3331-data)
6. [Single Boron Firmware State Machine](#single-boron-firmware-state-machine)
